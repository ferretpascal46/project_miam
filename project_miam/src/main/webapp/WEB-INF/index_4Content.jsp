		...
		<div class="grid_7">
			...
			<div class="news">
				...
				<div class="extra_wrapper">
					<div class="col1">Aenean nonummy hendrerit mau rellus porta.
						Fusce suscipit varius m sociis natoque penaibet mapaturent.</div>
					<p>Montes nasetur ridiculumula dui. Fusce feugiatlesuada o krjg
						fdio. Morbi nusem. GIoadscs lkierhdc v hfrjgDuis ultricies
						pharetra magna. Donec accusan mal esuada orcec sit amet eros.</p>
					<p>Lorem ipsum dolor sit amet consectetuer adipiscing elit.
						Mauris fermentum dictum magna. Sed oreetliquam tellus dolor
						elementum vel cursus eleife. agna. Donec accumsan malesuada orcec
						sit amet</p>
			...
			<div class="news mb0">
				...
				<div class="extra_wrapper">
					<div class="col1">Nuinean nonummy hendrerit mau rellus porta.
						Fusce varius m sociis natoque penaibet magni partur.</div>
					<p>Ent montes nasetur ridiculumula dui. KHgsce feugiat
						malesuada o krjg fdio. Joorbi nusem. GIoadscs lkierdc vhfrujgDuis
						ultricies pharetra magna. Donec accumsan masuada orcec sit amet
						eros.</p>
					<p>Hioasrem ipsum dolor sit amet consectetuer adiscing elit.
						Mauris fermentum dictum magna. Ed oreetliquam tellus dolor dapibus
						eget elementum vel cursus eleife. agna. Donec accumsan malesuada
						orcec sit amrbi.</p>
					<a href="#" class="btn">More</a>
				</div>
			</div>
			...
			<div class="grid_6">
				...
				<nav>
					<ul>
						...
						<li class="current"><a href="/WEB-INF/index_4.jsp">News
						</a></li>
						<li><a href="/WEB-INF/index_5.html">Contacts</a></li>
					</ul>
				</nav>
			</div>
			<div class="grid_6">
