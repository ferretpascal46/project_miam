<div class="content">
	...
	<div class="container_12">
		<div class="grid_6">
			<h2>Our Menu</h2>
			<p class="col2 inn1">
				<a href="#">Integer non metus justo ac posuere turpis. Integer
					iaculis porta metus, in aliquam orci vehicula sit amet. Suspendisse
					turpis mauris, laoreet ac aliquet a lobortis in massa. Etiam tortor
					metus, tincidunt vel congue etu</a>
			</p>
			<p>Aenean sed nunc lorem, nec ornare nibh. Pellentesque vitae sem
				odio. Vivamus vulputate est eget elit rutrum a consectetur justo
				aliquet. Aliquam hendrerit consectetur mi, non molestie massa
				venenatis quis. Integer aliquet euismod nisl, et sagittis sem
				scelerisque sit amet. Etiam dapibus, tellus et imperdiet pulvinar,
				urna nunc consectetur enim, in</p>
			<div class="menu">
		...
		<div class="grid_5 prefix_1">
			...
			<ul class="list l1">
				...
				<li><a href="#">Etiam tortor metus, tincidunt vel gtcongue
				</a></li>
				...
				<li><a href="#">Vivamus vulputate est eget elit s tellus et
				</a></li>
			...
			<div class="grid_6">
				...
				<nav>
					<ul>
						...
						<li class="current"><a href="index_2.jsp">Menu</a></li>
